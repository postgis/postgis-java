 ...
 * 
 */
package net.postgis.binary;

import net.postgis.Geometry;
import net.postgis.GeometryCollection;
import net.postgis.LineString;
import net.postgis.LinearRing;
import net.postgis.MultiLineString;
import net.postgis.MultiPoint;
import net.postgis.MultiPolygon;
import net.postgis.Point;
import net.postgis.Polygon;
